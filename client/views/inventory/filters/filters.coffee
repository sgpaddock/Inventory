Template.inventoryFilters.events
  ...
  'change input.filter-onReplacementCycle': (e, tpl) ->
    Iron.query.set 'onReplacementCycle', $(e.target).prop('checked')
...
Template.inventoryFilters.helpers
  ...
  onReplacementCycleFilterChecked: -> if Iron.query.get('onReplacementCycle') then "checked" else ""
